...
import 'package:booktickets_app/widgest/icon_text_widgest.dart';
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          const AppTicketTabs(fristTabs: 'Airline ticket', secondTabs: 'Hotel',),
              ...
              children: [
                ...
                Stack(
                  ...
                  child: Column(
                    ...
                    children: [
                      Text("Discount \nfor survey",style: styles.headLineStyle2.copyWith(fontWeight: FontWeight.bold,color: Colors.white,fontSize: 22)),
                      Gap(AppLayout.getHeight(10)),
                      Text("Take the survey about our service and get discount.",style: styles.textStyle.copyWith(color: Colors.white,fontWeight: FontWeight.w500),)
                    ],
                  ),
                ),
                Positioned(
                ...
                Container(
                  width: size.width*0.44,
                  height: AppLayout.getHeight(195),
                  padding: EdgeInsets.symmetric(vertical: AppLayout.getHeight(25),horizontal: AppLayout.getHeight(15)),
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(AppLayout.getHeight(18)),
